IF EXISTS (
		...
		FROM sysobjects
		WHERE type = 'P'
			AND NAME = 'USP_EX_GetAccountPagingAllActiveAccounts'
		)
BEGIN
	DROP PROCEDURE USP_EX_GetAccountPagingAllActiveAccounts;

	PRINT 'DROPPED USP_EX_GetAccountPagingAllActiveAccounts';
END
GO

/************************************************************************
** New Name:     USP_EX_GetAccountPagingAllActiveAccounts  
** Old Name:     USP_EIX_AccountPagingAllActiveAccountsSelProc  
...
********************************************************************************/
CREATE PROCEDURE [dbo].[USP_EX_GetAccountPagingAllActiveAccounts] -- 0,0,0, 1,18,0,'Advent_ID',0,'','','','',''     
	@ModuleId INT
...
AND AccMstr.AllianceNumber = (
	...
	AND AccMstr.ActiveFlag = -1 AND AccMstr.ClosedFlag =0
...
BEGIN
	PRINT 'CREATED USP_EX_GetAccountPagingAllActiveAccounts';
END