IF EXISTS (
		...
		FROM sysobjects
		WHERE type = 'P'
			AND NAME = 'USP_EX_GetAccountPagingMyAccounts'
		)
BEGIN
	DROP PROCEDURE USP_EX_GetAccountPagingMyAccounts;

	PRINT 'DROPPED USP_EX_GetAccountPagingMyAccounts';
END
GO

/******************************************************************
** New Name:     USP_EX_GetAccountPagingMyAccounts  
** Old Name:     USP_EIX_AccountPagingMyAccountsSelProc  
...
**  
** Sample Call  
   EXEC USP_EX_GetAccountPagingMyAccounts  
  @ModuleId  =0,  
 @ClientId  =0,  
 @ProgramID =0,  
 @startrow  =1,  
...
*********************************************************************************/
CREATE PROCEDURE [dbo].[USP_EX_GetAccountPagingMyAccounts] --100115,0,0,0, 1,18,0,'Advent_ID',0,'','','','',''   
	@USER_ID INT
	,@ModuleId INT
...
DELETE FROM #ACCOUNT WHERE STATUS='Inactive'
...
BEGIN
	PRINT 'CREATED USP_EX_GetAccountPagingMyAccounts';
END