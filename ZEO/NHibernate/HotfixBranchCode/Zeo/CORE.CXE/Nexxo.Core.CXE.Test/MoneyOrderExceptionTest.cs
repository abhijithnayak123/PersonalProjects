...
namespace MGI.Core.CXE.MoneyOrderExceptionTest
{
    ...
    class MoneyOrderExceptionTest
    {
        ...
        public void StageMoneyOrderUpdateStatusLookupThrows()
        {
            ...
            MinorCodeMatch<CXEMoneyOrderException>(() => _svc.Update(1, newStatus, timeZone), CXEMoneyOrderException.MONEYORDER_NOT_FOUND);
        }
        ...
        public void StageMoneyOrderUpdateCheckNumberLookupThrows()
        {
            ...
            mokMoneyOrderStageRepo.Setup(m => m.FindBy(It.IsAny<Expression<Func<Data.Transactions.Stage.MoneyOrder, bool>>>())).Throws(new Exception());
            MinorCodeMatch<CXEMoneyOrderException>(() => _svc.Update(1, newCheckNumber, timeZone), CXEMoneyOrderException.MONEYORDER_NOT_FOUND);
        }
        ...
        {
            mokMoneyOrderStageRepo.Setup(m => m.FindBy(It.IsAny<Expression<Func<Data.Transactions.Stage.MoneyOrder, bool>>>())).Throws(new Exception());
            MinorCodeMatch<CXEMoneyOrderException>(() => _svc.Commit(1), CXEMoneyOrderException.MONEYORDER_NOT_FOUND);
        }
        ...
        public void CommitMoneyOrderLookupThrows()
        {
            ...
            MinorCodeMatch<CXEMoneyOrderException>(() => _svc.Get(1), CXEMoneyOrderException.MONEYORDER_NOT_FOUND);
        }
        ...
        {
            mokMoneyOrderStageRepo.Setup(m => m.FindBy(It.IsAny<Expression<Func<Data.Transactions.Stage.MoneyOrder, bool>>>())).Throws(new Exception());
            MinorCodeMatch<CXEMoneyOrderException>(() => _svc.GetStage(1), CXEMoneyOrderException.MONEYORDER_NOT_FOUND);
        }
