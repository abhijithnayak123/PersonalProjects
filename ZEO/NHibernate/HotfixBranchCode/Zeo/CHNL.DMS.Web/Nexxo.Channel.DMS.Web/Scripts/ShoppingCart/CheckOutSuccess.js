...
function preparePrintList(receiptsListGlb) {
    ...
    $('<tr><td style="position:absolute;float: left; margin-left: 35%; text-align: left; padding-top: 3%; padding-right: 3%; padding-bottom: 3%; padding-left: 3%;" colspan="4"><div id="btndivs" class="SrchButtonWdth SrchButtonWdths" style=""><a id="linkbtn" class="anc_link_btn" style="visibility:hidden;background-color: rgb(0, 105, 55);" href="' + CustomerSearchURL + '">Done</a></div></td></tr>').appendTo('#ReceiptsTable');
