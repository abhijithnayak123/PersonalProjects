    ...
    jQuery("#jqTable").jqGrid(
        {
            ...
            loadComplete: function (data) {
                ...
                if (errmsg!=null && errmsg.indexOf("1011.2011.700.2") >= 0) {
                    showExceptionPopupMsg(errmsg);
                    hideSpinner();
                    return;
                }
                //AL-4348 end
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.success == undefined) {
                if (data == "True") {
                    window.location.href = ProfileSummaryNavigationURL + '?IsException=false&ExceptionMsg=""';
                }
                else {
