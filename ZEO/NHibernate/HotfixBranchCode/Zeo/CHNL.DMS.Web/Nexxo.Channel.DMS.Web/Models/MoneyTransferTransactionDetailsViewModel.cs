...
namespace MGI.Channel.DMS.Web.Models
{
    public class MoneyTransferTransactionDetailsViewModel : TransactionDetailsViewModel
    {
        ...
        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "MoneyTrasferTrxMTCN")]
        public string MTCN { get; set; }

        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "MoneyTransferTrxOriginalTransactionId")]
        ...
        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyTransferAmount")]
        public decimal TransferAmount { get; set; }


        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "MoneyTransferTrxRecvName")]
        public string ReceiverName { get; set; }


        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "MoneyTransferTrxRecvAddress")]
        public string ReceiverAddress { get; set; }

        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "MoneyTransferTrxSenderName")]
        ...
        //[Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "CancelCategory")]
        //public string CancelCategory { get; set; }

        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "ReasonforCancel")]
        ...
        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyRefundStatus")]
        public string RefundStatus { get; set; }

        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyRefundCategory")]
        public IEnumerable<SelectListItem> RefundCategory { get; set; }

       // [Required(ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "ReasonforRefundRequired")]
        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "ReasonforRefund")]
       ...
       // [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyFirstName")]
        ...
        [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyMiddleName")]
        ...
        public string RecieverLastName { get; set; }
         ...
         [Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyRecvSecLastName")]
