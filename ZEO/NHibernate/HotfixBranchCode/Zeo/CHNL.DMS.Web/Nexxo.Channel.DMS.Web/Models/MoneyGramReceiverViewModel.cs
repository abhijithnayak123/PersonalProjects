...
namespace MGI.Channel.DMS.Web.Models
{
	...
	public class MoneyGramReceiverViewModel : BaseModel
	{
		...
		[RegularExpression(@"^[a-zA-Z\- ']*$", ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "PersonalLastNameRegularExpression")]
		[StringLength(30, ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "PersonalLastNameStringLength")]
        ...
        [RegularExpression(@"^[a-zA-Z\- ']*$", ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "PersonalMiddleNameRegularExpression")]
		...
		[RegularExpression(@"^[a-zA-Z\- ']*$", ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "PersonalSecondLastNameRegularExpression")]
		...
		//For MGI Added
		[Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyIsReceiverHasPhotoId")]
		public  bool IsReceiverHasPhotoId { get; set; }

		[Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyMGITestQuestion")]
		[ConditionalReceiverHasPhotoIDAttribute("IsReceiverHasPhotoId", ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyTestQuestionRequired")]
		[ConditionalRequired("TestQuestion", "TestAnswer", ErrorMessage = "Please enter test answer.")]		
		public string TestQuestion { get; set; }

		[Display(ResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), Name = "SendMoneyMGITestAnswer")]
		[ConditionalReceiverHasPhotoIDAttribute("IsReceiverHasPhotoId", ErrorMessageResourceType = typeof(MGI.Channel.DMS.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyTestAnswerRequired")]
