...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IAgentService
	{
		...
		AgentSession AuthenticateSSO(AgentSSO ssoAgent, string channelPartner, string terminalName, MGI.Channel.DMS.Server.Data.MGIContext context);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		bool UpdateSession(long agentSessionId, Terminal terminal, MGI.Channel.DMS.Server.Data.MGIContext context);
	}
}
