...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IFundsProcessorService
	{
		...
		long Add(long customerSessionId, FundsProcessorAccount fundsAccount, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		bool AuthenticateCard(long customerSessionId, string cardNumber, string pin, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		long ActivateGPRCard(long customerSessionId, Funds funds, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Data.CardInfo GetBalance(long customerSessionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		FundsProcessorAccount LookupForPAN(long customerSessionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		TransactionFee GetFee(long customerSessionId, decimal amount, FundType fundsType, MGIContext context);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		long UpdateFundAmount(long customerSessionId, long cxeFundTrxId, decimal amount, FundType fundType, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		List<CardTransactionHistory> GetCardTransactionHistory(long customerSessionId, TransactionHistoryRequest request, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		List<ShippingTypes> GetShippingTypes(long customerSessionId, MGIContext mgiContext);

		[OperationContract(Name = "GetShippingFee")]
		[FaultContract(typeof(NexxoSOAPFault))]
		double GetShippingFee(long customerSessionId, CardMaintenanceInfo cardMaintenanceInfo, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		long AssociateCard(long customerSessionId, FundsProcessorAccount fundsAccount, MGIContext mgiContext);

		[OperationContract(Name = "GetFundFee")]
		[FaultContract(typeof(NexxoSOAPFault))]
		double GetFundFee(long customerSessionId, CardMaintenanceInfo cardMaintenanceInfo, MGIContext mgiContext);
