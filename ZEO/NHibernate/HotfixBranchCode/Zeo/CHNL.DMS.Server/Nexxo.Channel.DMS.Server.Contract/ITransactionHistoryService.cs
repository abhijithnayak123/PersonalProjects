...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface ITransactionHistoryService
	{
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        List<TransactionHistory> GetAgentTransactionHistory(long agentSessionId, long? agentId, string transactionType, string location, bool showAll, long transactionId, int duration, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        SharedData.MoneyTransferTransaction GetMoneyTransferTransaction(long agentSessionId, long customerSessionId, long transactionId, MGIContext mgiContext);
