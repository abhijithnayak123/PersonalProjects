...
namespace MGI.Channel.DMS.Server.Contract
{
    ...
    public interface IMoneyOrderService
    {
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        MoneyOrder PurchaseMoneyOrder(long customerSessionId, MoneyOrderPurchase moneyOrderPurchase, MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        void CancelMoneyOrder(long customerSessionId, long moneyOrderId, MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        void UpdateMoneyOrder(long customerSessionId, MoneyOrderTransaction moneyOrderTransaction, long moneyOrderId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        CheckPrint GenerateCheckPrintForMoneyOrder(long moneyOrderId, long customerSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        CheckPrint GenerateMoneyOrderDiagnostics(long agentSessionId, MGIContext mgiContext);
    }
}
