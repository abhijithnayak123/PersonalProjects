    ...
    public class ChannelPartnerServiceImpl : IChannelPartnerService, IChannelPartnerPrefundingService
	{
        ...
        public Data.ChannelPartner ChannelPartnerConfig(long channelPartnerId)
        {
			...
			{ 
                ...
                throw new ChannelPartnerException(ChannelPartnerException.CHANNEL_PARTNER_NOT_FOUND, ex);
            }
        ...
        public List<string> Locations(string channelPartner)
        {
            ...
            {
                throw new ChannelPartnerException(ChannelPartnerException.LOCATIONS_NOT_FOUND_FOR_CHANNEL_PARTNER, ex);
            }
        }
        ...
        public List<string> GetCheckTypes()
        {
            ...
            if (checkTypes == null)
                throw new ChannelPartnerException(ChannelPartnerException.CHANNEL_PARTNER_CHECKTYPES_NOT_FOUND, "Check Types Not Found");
        ...
        public CheckType GetCheckType(string name)
        {
            ...
            if (checkType == null)
                throw new ChannelPartnerException(ChannelPartnerException.CHANNEL_PARTNER_CHECKTYPE_NOT_FOUND, string.Format("Check Type '{0}' not found", name));
            return checkType;
        }
        ...
        public CheckType GetCheckType(int Id)
        {
            ...
            if (checkType == null)
                throw new ChannelPartnerException(ChannelPartnerException.CHANNEL_PARTNER_CHECKTYPE_NOT_FOUND, string.Format("Check Type '{0}' not found", Id));
            return checkType;
        }
		...
		public ChannelPartnerCertificate GetChannelPartnerCertificateInfo(long channelPartnerId, string issuer)
		{
			...
			{
				throw new ChannelPartnerException(ChannelPartnerException.CHANNEL_PARTNER_CERTIFICATE_INFO_NOT_FOUND, ex);
			}
