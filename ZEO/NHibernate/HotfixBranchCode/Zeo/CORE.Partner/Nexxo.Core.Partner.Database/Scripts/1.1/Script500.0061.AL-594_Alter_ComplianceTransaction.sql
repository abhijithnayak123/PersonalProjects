...
AS
SELECT	tBP.TxnPK rowguid, tBP.TransactionID AS TransactionId, tPC.CustomerID as CustomerId, tBP.DTCreate, 4 AS TransactionType,
...
UNION ALL
SELECT	tC.txnPK rowguid, tC.TransactionID AS TransactionId, tPC.CustomerID as CustomerId, tC.DTCreate, 2 AS TransactionType,
...
SELECT	tMO.txnPK rowguid, tMO.TransactionID AS TransactionId, tPC.CustomerID as CustomerId, tMO.DTCreate, 5 AS TransactionType,
...
SELECT	tF.txnPK rowguid, tF.TransactionID AS TransactionId, tPC.CustomerID as CustomerId, tF.DTCreate, 
...
SELECT	tMT.txnPK rowguid, tMT.TransactionID AS TransactionId, tPC.CustomerID as CustomerId, tMT.DTCreate, 6 AS TransactionType,
