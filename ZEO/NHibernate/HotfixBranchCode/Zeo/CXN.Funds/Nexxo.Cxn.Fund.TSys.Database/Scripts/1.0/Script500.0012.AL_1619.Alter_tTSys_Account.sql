...
WHERE 
	  TABLE_NAME = 'tTSys_Account' AND  COLUMN_NAME = 'IDCode')
BEGIN
	ALTER TABLE [dbo].[tTSys_Account]
...
(
	  SELECT * FROM INFORMATION_SCHEMA.COLUMNS
WHERE 
	  TABLE_NAME = 'tTSys_Account_Aud' AND  COLUMN_NAME = 'IDCode')
BEGIN
	ALTER TABLE [dbo].[tTSys_Account_Aud]
	ADD IDCode varchar(2)
END 
GO
BEGIN
UPDATE [dbo].[tTSys_Account]
set IDCode = (
