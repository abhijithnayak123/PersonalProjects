...
namespace MGI.Biz.MoneyOrder.Test
{
	...
	public class MoneyOrderEngineServiceImplTest : BaseClass_Fixture
	{
		...
		public void Can_Add_MoneyOrder_Trxn()
		{
			...
			CxeMoneyOrderSvc.Verify(moq => moq.Create(It.IsAny<CXEData.Transactions.Stage.MoneyOrder>(), It.IsAny<string>()), Times.Exactly(1));
			CxeMoneyOrderSvc.Verify(moq => moq.Update(It.IsAny<long>(), It.IsAny<int>(), It.IsAny<string>()), Times.Exactly(1));
		}
		...
		public void Can_Commit_MoneyOrder_Trxn()
		{
			...
			CxeMoneyOrderSvc.Verify(moq => moq.Commit(It.IsAny<long>()), Times.Exactly(1));
			CxeMoneyOrderSvc.Verify(moq => moq.Update(It.IsAny<long>(), It.IsAny<int>(), It.IsAny<string>()), Times.Exactly(2));
		}
