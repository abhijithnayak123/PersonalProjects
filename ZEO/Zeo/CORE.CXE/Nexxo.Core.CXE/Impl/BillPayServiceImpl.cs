	...
	public class BillPayServiceImpl : IBillPayService
	{
		...
		public long Create(BillPayStage billPay)
		{
			...
			catch (Exception ex)
			{
                ...
                throw new CXEBillpayException(CXEBillpayException.BILLPAY_STAGE_FAILED, ex);
			}
		}
		...
		public void Update(long Id, TransactionStates state, string confirmationNumber)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEBillpayException(CXEBillpayException.BILLPAY_UPDATE_FAILED,ex);
			}
		}
		...
		public void Commit(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEBillpayException(CXEBillpayException.BILLPAY_COMMIT_FAILED, ex);
			}
		}
		...
		public BillPayCommit Get(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEBillpayException(CXEBillpayException.BILLPAY_GET_FAILED, ex);
			}
		}
