	...
	public class MoneyTransferServiceImpl : IMoneyTransferService
	{
		...
		public long Create(Data.Transactions.Stage.MoneyTransfer moneytransfer)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyTransferException(CXEMoneyTransferException.MONEYTRANSFER_CREATE_FAILED, ex);
			}
		}
		...
		public void Update(long Id, TransactionStates state, string timeZone)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyTransferException(CXEMoneyTransferException.MONEYTRANSFER_UPDATE_FAILED, ex);
			}
		}
		...
		public void Commit(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyTransferException(CXEMoneyTransferException.MONEYTRANSFER_COMMIT_FAILED, ex);
			}
		}
		...
		public Data.Transactions.Commit.MoneyTransfer Get(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyTransferException(CXEMoneyTransferException.MONEYTRANSFER_GET_FAILED, ex);
			}
		}
		...
		public Data.Transactions.Stage.MoneyTransfer GetStage(long Id)
		{
			...
			catch (Exception ex)
			{
                ...
                NLogger.Error("Error in retrieving money transfer. " + ex.Message);
				throw new CXEMoneyTransferException(CXEMoneyTransferException.MONEYTRANSFER_GETSTAGE_FAILED, ex);
			}
