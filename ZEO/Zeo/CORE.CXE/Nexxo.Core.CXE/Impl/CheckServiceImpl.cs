	...
	public class CheckServiceImpl : ICheckService
	{
		...
		public CheckCommit Get(long Id)
		{
			...
			{			
				...
				throw new CXECheckException(CXECheckException.CHECK_GET_FAILED,ex);
			}
		}
		...
		public void Update(long Id, int newStatus,string timezone)
        {
            ...
            {              
                ...
                throw new CXECheckException(CXECheckException.CHECK_UPDATE_FAILED, ex);
            }
        }
		...
		public long Create(CheckStage check,string timezone)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXECheckException(CXECheckException.CHECK_CREATE_FAILED,ex);
			}
		}
		...
		public void Commit(long Id)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXECheckException(CXECheckException.CHECK_COMMIT_FAILED, ex);
            }
        }
