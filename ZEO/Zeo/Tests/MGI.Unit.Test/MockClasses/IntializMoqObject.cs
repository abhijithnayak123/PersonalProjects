	...
	public class IntializMoqObject : BaseClass_Fixture
	{
		...
		internal static List<PTNRData.ChannelPartner> channelPartners = new List<PTNRData.ChannelPartner>() {
			...
			new PTNRData.ChannelPartner()
			{
				...
				CardPresenceVerificationConfig = 1,
				ChannelPartnerConfig = new PTNRData.ChannelPartnerConfig(){ MasterSSN = "888888888",FrankData="%20344454%"},
		...
		internal static List<PTNRData.Customer> ptrnCustomers = new List<PTNRData.Customer>() { 
			...
			new PTNRData.Customer() // Customer who as record in CXECustomer without CXEAccount and PartnerAccount
			{
				AgentSessionId = Guid.Parse("45BA3151-5A89-4424-BF73-4629CE1C14DC"), 
				ChannelPartner = channelPartners.Find(a=>a.Name == "Synovus"),
				ChannelPartnerId = Guid.Parse("EC6AAAE3-2BA7-4E0B-898E-D296DB432C17"), 
				CustomerProfileStatus = ProfileStatus.Active,
				CXEId = 1000000000000100,
				ReferralCode = "1234",
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000100,
			},
			new PTNRData.Customer() // Customer who as record in CXECustomer without CXEAccount and with PartnerAccount
			{
				AgentSessionId = Guid.Parse("45BA3151-5A89-4424-BF73-4629CE1C14DC"), 
				ChannelPartner = channelPartners.Find(a=>a.Name == "Synovus"),
				ChannelPartnerId = Guid.Parse("EC6AAAE3-2BA7-4E0B-898E-D296DB432C17"), 
				CustomerProfileStatus = ProfileStatus.Active,
				CXEId = 1000000000000101,
				ReferralCode = "1234",
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000101,
			...
			new PTNRData.Customer() // Customer who as record in CXECustomer with CXEAccount and without PartnerAccount
			{
				AgentSessionId = Guid.Parse("45BA3151-5A89-4424-BF73-4629CE1C14DC"), 
				ChannelPartner = channelPartners.Find(a=>a.Name == "Synovus"),
				ChannelPartnerId = Guid.Parse("EC6AAAE3-2BA7-4E0B-898E-D296DB432C17"), 
				CustomerProfileStatus = ProfileStatus.Active,
				CXEId = 1000000000000102,
				ReferralCode = "1234",
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000102,
			},
			new PTNRData.Customer() // Customer who as record in CXECustomer with CXEAccount and PartnerAccount
			{
				AgentSessionId = Guid.Parse("45BA3151-5A89-4424-BF73-4629CE1C14DC"), 
				ChannelPartner = channelPartners.Find(a=>a.Name == "Synovus"),
				ChannelPartnerId = Guid.Parse("EC6AAAE3-2BA7-4E0B-898E-D296DB432C17"), 
				CustomerProfileStatus = ProfileStatus.Active,
				CXEId = 1000000000000103,
				ReferralCode = "1234",
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000103,
			...
			new PTNRData.Customer() // Customer who as record in CXECustomer with CXEAccount and PartnerAccount
			{
				...
				ChannelPartnerId = Guid.Parse("EC6AAAE3-2BA7-4E0B-898E-D296DB432C17"), 
				CustomerProfileStatus = ProfileStatus.Active,
				CXEId = 1000000000000104,
				ReferralCode = "1234",
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000104,
				Accounts = new List<PTNRData.Account>()
				{
					new PTNRData.Account()
					{
						CXNId = 1000000000,
		...
		internal static List<PTNRData.CustomerSession> customerSessions = new List<PTNRData.CustomerSession>() {
			...
			new PTNRData.CustomerSession()
			{
				...
				rowguid = Guid.NewGuid(),
				AgentSession = agentSessions.Find(a=>a.Id == 1000000000),
				Customer = ptrnCustomers.Find(a=>a.CXEId == 1000000000000002),
			},
			new PTNRData.CustomerSession()
			{
				CardPresent = true,
				...
				rowguid = Guid.NewGuid(),
				AgentSession = agentSessions.Find(a=>a.Id == 1000000000),
				Customer = ptrnCustomers.Find(a=>a.CXEId == 1000000000000003),
			},
			new PTNRData.CustomerSession()
			{
				CardPresent = true,
				...
				rowguid = Guid.NewGuid(),
				AgentSession = agentSessions.Find(a=>a.Id == 1000000000),
				Customer = ptrnCustomers.Find(a=>a.CXEId == 1000000000000004),
			},
			...
			{ 
				...
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
				Customer = ptrnCustomers.Find(a=>a.CXEId == 1000000000000005),
				Id = 1000000008,
			},
			new PTNRData.CustomerSession() 
			{ 
			...
			new PTNRData.CustomerSession() // CustomerSession without CXEAccount and PartnerAccount
			{
				Id = 1000000100,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000100),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			},
			new PTNRData.CustomerSession() // CustomerSession without CXEAccount and with PartnerAccount
			{
				Id = 1000000101,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000101),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			},
			new PTNRData.CustomerSession() // CustomerSession with CXEAccount and without PartnerAccount
			{
				Id = 1000000102,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000102),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			},
			new PTNRData.CustomerSession() // CustomerSession with CXEAccount and PartnerAccount
			{
				Id = 1000000103,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000103),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			...
			new PTNRData.CustomerSession() // CustomerSession with CXEAccount and PartnerAccount
			{
				Id = 1000000104,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000104),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			...
			new PTNRData.CustomerSession()
			{
				Id = 1000000016,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000006),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			...
			new PTNRData.CustomerSession()
			{
				Id = 1000000017,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000105),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			...
			new PTNRData.CustomerSession()
			{
				Id = 1000000018,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000106),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
			...
			new PTNRData.CustomerSession()
			{
				Id = 1000000019,
				rowguid = Guid.NewGuid(),
				Customer = ptrnCustomers.Find(a=>a.Id == 1000000000000107),
				DTServerCreate = DateTime.Now, 
				DTTerminalCreate = DateTime.Now, 
				TimezoneID = "Central Standard Time",
				AgentSession = agentSessions.Find(a=>a.Id == 1000000001),
		...
		internal static List<CXEData.Customer> coreCxeCustomers = new List<CXEData.Customer>() { 
			...
			new CXEData.Customer(){ // For Money Order
				...
				DTTerminalCreate = DateTime.Now,
				Id = 1000000000000002,
				Accounts = new List<CXEData.Account>()
				{
					new CXEData.Account()
					{
						DTServerCreate = DateTime.Now,
			...
			new CXEData.Customer(){  //CXECustomer without CXEAccount
				Address1 = "BAY",
				Address2 = "Street",
				FirstName = "Nitish",
				LastName = "Biradar",
			...
			new CXEData.Customer(){  //CXECustomer with ProviderAccount for Synovus Channel Partner
				Address1 = "BAY",
				Address2 = "Street",
				FirstName = "Nitish",
				LastName = "Biradar",
			...
			new CXEData.Customer(){  //CXECustomer with ProviderAccount for TCF Channel Partner
				Address1 = "BAY",
				Address2 = "Street",
				FirstName = "Nitish",
				LastName = "Biradar",
			...
			new CXEData.Customer(){  //CXECustomer with ProviderAccount for MGI Channel Partner
				Address1 = "BAY",
				Address2 = "Street",
				FirstName = "Nitish",
				LastName = "Biradar",
			...
			new CXEData.Customer(){ //no employment details
				Address1 = "BAY",
				Address2 = "Street",
				FirstName = "Nitish",
				LastName = "Biradar",
			...
			new CXEData.Customer(){
				...
				Id = 1000000000000106,
				EmploymentDetails = new CXEData.CustomerEmploymentDetails(){
					Occupation = "00001", //its code for TCF
					DTServerCreate = DateTime.Now,
					DTTerminalCreate = DateTime.Now,
					Employer = "Testing",
					EmployerPhone = "9874563215",
		...
		internal List<PTNRData.Prospect> prospects = new List<PTNRData.Prospect>() 
		{
			...
			{ 
				...
				EmploymentDetails = new PTNRData.ProspectEmploymentDetails()
				{
					Occupation = "Student",
					OccupationDescription = "Maths",
					Employer = "Teacher",
					EmployerPhone = "892345672123",
				},				
			},
			new PTNRData.Prospect()
			{ 
			...
			{ 
				...
				SecondaryCountryCitizenShip = "US",
				LastName = "Martin",
				AlloyID = 1000000000000122,
				ReferralCode = "1000000000000000",
				ClientID = "1000000000011110",
				GovernmentId = new PTNRData.ProspectGovernmentId()
				{
					Id = Guid.NewGuid(),
					IdType = new PTNRData.NexxoIdType(){ Country = "US", CountryId = new PTNRData.MasterCountry(){ Name = "United States"}},
					ExpirationDate = new DateTime(2020,10,10),
				},
				EmploymentDetails = new ProspectEmploymentDetails()
				{
					Employer = "TestEmployer",
					Occupation = "Student",
					OccupationDescription = "TestDesc",
					Prospect = new Prospect()
				},
				Groups = new List<ProspectGroupSetting>()
				{
					new ProspectGroupSetting() { channelPartnerGroupId = 1, prospect = new Prospect()}
				}
			...
			{ 
				...
				SecondaryCountryCitizenShip = "US",
				LastName = "Martin",
				AlloyID = 1000000000000128,
				ClientID = "1000000000011110",
				ReferralCode = "1000000000000125",
				GovernmentId = new PTNRData.ProspectGovernmentId()
				{
					Id = Guid.NewGuid(),
					IdType = new PTNRData.NexxoIdType(){ Country = "US", CountryId = new PTNRData.MasterCountry(){ Name = "United State"}},
		...
		internal List<CheckTrx> checkTrxns = new List<CheckTrx>() 
		{
			...
			new CheckTrx(){ Id = 1000000020, Amount = 100, CheckNumber = "123456", ConfirmationNumber = "1594815926", Status = CheckStatus.Declined },
		...
		internal List<CXEData.CustomerPreferedProduct> customerPreferdProducts = new List<CXEData.CustomerPreferedProduct>() {
			new CXEData.CustomerPreferedProduct(){ ProductId = 14563, BillerCode = "14563" },
			new CXEData.CustomerPreferedProduct(){ ProductId = 1234561830, BillerCode = "1234561830"}
		};
		#endregion
		...
		internal List<CXEData.Transactions.Stage.MoneyOrder> stageMoneyOrders = new List<CXEData.Transactions.Stage.MoneyOrder>() 
		{
            ...
            new CXEData.Transactions.Stage.MoneyOrder()
			{
				...
				DTServerCreate = DateTime.Now,
				DTTerminalCreate = DateTime.Now,
                MoneyOrderCheckNumber="1243434",
                RoutingNumber="121313",
