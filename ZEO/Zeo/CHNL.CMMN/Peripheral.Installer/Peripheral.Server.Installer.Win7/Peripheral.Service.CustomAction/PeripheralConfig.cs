namespace Peripheral.Service.CustomAction
{
	...
	{
		public const string TCPPORT_CHECK_MESSAGE            = "Open TCP port for Nexxo Peripheral Server (default is TCP port 18732)";
...
public const int HTTPS_PORT_NUMBER					 = 18731;
        public const string EPSON_ROLL_Printer_MESSAGE       = "EPSON ROLL Printer Driver";
        public const string PERIPHERAL_SERVICE_URL           = "https://ps-zeo.tcfbank.com:{0}/Peripheral/";
	    ...
	    public const string PRODUCTVERSION                   = "3.4.6.0";
    }
}
