...
using System.Text;
using TCF.Zeo.Peripheral.Check.Messenger.Data;
using TCF.Zeo.Peripheral.Server.Contract;
using TCF.Zeo.Peripheral.Server.Data;
using System.Diagnostics;
using Spring.Context.Support;
using Spring.Context;
using ChatMessage = TCF.Zeo.Peripheral.Server.Data.ChatMessage;
using IPeripheralMessenger = TCF.Zeo.Peripheral.Check.Messenger.Contract;
using IPeripheralMessengerData = TCF.Zeo.Peripheral.Check.Messenger.Data;
