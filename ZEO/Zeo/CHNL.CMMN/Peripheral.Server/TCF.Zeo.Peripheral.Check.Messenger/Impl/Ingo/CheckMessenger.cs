...
using TCF.Zeo.Peripheral.Check.Messenger.Contract;
using TCF.Zeo.Peripheral.Check.Messenger.Data;
using ChexarIO.Communication.Impl;
using ChatMessage = TCF.Zeo.Peripheral.Check.Messenger.Data.ChatMessage;
using MessageTypes = ChexarIO.Communication.Data.MessageTypes;

namespace TCF.Zeo.Peripheral.Check.Messenger.Ingo.Impl
{
