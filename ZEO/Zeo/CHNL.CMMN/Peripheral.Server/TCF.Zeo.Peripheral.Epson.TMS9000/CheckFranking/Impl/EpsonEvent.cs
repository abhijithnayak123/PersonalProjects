...
namespace TCF.Zeo.Peripheral.CheckFranking.Epson.TMS9000.Impl
{
	public partial class TMS9000 : TMS9000Base
	{
        ...
        public void CheckFrankStatusCallback(int transactionNumber, MainStatus mainStatus, ErrorCode subStatus, string portName)
        {
            ...
            {
                Trace.WriteLine("TCF.Zeo.Peripheral.CheckPrinter.Epson.TMS9000.Impl.EpsonEvent CheckPrintStatusCallback Failed : " + errResult.ToString(), DateTime.Now.ToString());
        ...
        public void CheckPrinterReadyCallback(int TransactionNumber, string portName)
        {
            if (errResult != ErrorCode.SUCCESS)
            {
                Trace.WriteLine("TCF.Zeo.Peripheral.CheckPrinter.Epson.TMS9000.Impl.EpsonEvent CheckPrinterReadyCallback Failed : " + errResult.ToString(), DateTime.Now.ToString());
                return;
            }
            errResult = ErrorCode.SUCCESS;
