...
namespace TCF.Zeo.Peripheral.Printer.EpsonTMS9000.Impl
{
	public static class EpsonException
	{
		...
		static public String errorDescription;
		static public int errorCode;
		static public bool errorStatus;
		...
		static public void SetError(ErrorCode err, String msg)
		{
        ...
        static public void SetUserException(int err, String errorMsg, string errorDesc, string thisTrace)
        {
            if (err != 0)
            {
                errorCode = err;
                ...
                stackTrace = thisTrace;
            }
        }
        /*
        public static EpsonCheckScannerError Error()
        {
            EpsonCheckScannerError err = new EpsonCheckScannerError();
            err.CopyFromException();
            return err;
        }
         * */
		...
		static private String GetDescription(ErrorCode err)
		{
			...
			switch (err)
			{
				...
				case ErrorCode.ERR_PAPER_INSERT:
					str = "Roll Paper not set properly.";
					break;
