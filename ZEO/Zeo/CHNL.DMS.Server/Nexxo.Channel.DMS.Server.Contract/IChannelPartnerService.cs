...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IChannelPartnerService
	{
		...
		Response Locations(long agentSessionId, string channelPartner, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response ChannelPartnerConfig(string channelPartner, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        Response GetTipsAndOffers(long agentSessionId, string channelPartner, string language, string viewName, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetPartnerGroups(string channelPartner, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetChannelPartnerCertificateInfo(long channelPartnerId, string issuer, MGIContext mgiContext);
	}
}
