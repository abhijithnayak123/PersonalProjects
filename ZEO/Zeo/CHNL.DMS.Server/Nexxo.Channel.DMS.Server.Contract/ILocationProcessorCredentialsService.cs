...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface ILocationProcessorCredentialsService
	{
		...
		[OperationContract]
		Response GetLocationProcessorCredentials(long agentSessionId, long locationId, MGIContext mgiContext);
		...
		Response Save(long agentSessionId, long locationId, ProcessorCredential processorCredentials, MGIContext mgiContext);
	}
}
