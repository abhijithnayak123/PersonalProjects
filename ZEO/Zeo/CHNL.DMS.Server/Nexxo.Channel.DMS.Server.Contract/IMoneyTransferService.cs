...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IMoneyTransferService
	{
        ...
        Response GetReceivers(long customerSessionId, string lastName, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetReceiver(long customerSessionId, long Id, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetReceiver(long customerSessionId, string fullName, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddReceiver(long customerSessionId, Receiver receiver, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response EditReceiver(long customerSessionId, Receiver receiver, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetFrequentReceivers(long customerSessionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetFee(long customerSessionId, FeeRequest feeRequest, MGIContext mgiContext);
		...
		[OperationContract()]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response ValidateTransfer(long customerSessionId, ValidateRequest validateRequest, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response Get(long customerSessionId, ReceiveMoneyRequest receiveMoneyRequest, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response UpdateWUAccount(long customerSessionId, string WUGoldCardNumber, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response WUCardEnrollment(long customerSessionId, XferPaymentDetails paymentDetails, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response WUCardLookup(long customerSessionId, CardLookupDetails wucardlookupreq, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetWUCardAccount(long customerSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response DisplayWUCardAccountInfo(long customerSessionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response Cancel(long customerSessionId, long transactionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetCardInfoXfer(long customerSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddPastReceivers(long customerSessionId, string cardNumber, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response DeleteFavoriteReceiver(long customerSessionId, long receiverId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetDeliveryServices(long customerSessionId, DeliveryServiceRequest request, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetXfrProviderAttributes(long customerSessionId, AttributeRequest attributeRequest, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
        Response IsSWBStateXfer(long customerSessionId, string locationState, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetAgentXfer(long agentSessionId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        Response StageRefundSendMoney(long customerSessionId, RefundSendMoneyRequest moneyTransferRefund, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response SendMoneyRefund(long customerSessionId, RefundSendMoneyRequest moneyTransferRefund, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetStatus(long customerSessionId, string confirmationNumber, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response SendMoneySearch(long customerSessionId, SendMoneySearchRequest request, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response StageModifySendMoney(long customerSessionId, ModifySendMoneyRequest modifySendMoney, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response GetMoneyTransferDetailsTransaction(long customerSessionId, long transactionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response AuthorizeModifySendMoney(long customerSessionId, ModifySendMoneyRequest modifySendMoney, MGIContext mgiContext);
