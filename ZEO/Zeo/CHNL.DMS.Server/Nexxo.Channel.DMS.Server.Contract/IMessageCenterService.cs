...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IMessageCenterService
	{
		...
		Response GetAgentMessages(long agentSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetMessageDetails(long agentSessionId, long transactionId, MGIContext mgiContext);
