...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IShoppingCartService
    {
		...
		Response AddCheck(long customerSessionId, long checkId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddFunds(long customerSessionId, long fundsId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddBillPay(long customerSessionId, long billPayId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddMoneyOrder(long customerSessionId, long moneyOrderId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response AddMoneyTransfer(long customerSessionId, long moneyTransferId, MGIContext mgiContext);
        ...
        [OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddCash(long customerSessionId, long cashTxnId, MGIContext mgiContext);
        ...
        [OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response RemoveCheck(long customerSessionId, long checkId, bool isParkedTransaction, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response RemoveFunds(long customerSessionId, long fundsId, bool isParkedTransaction, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response RemoveBillPay(long customerSessionId, long billPayId, bool isParkedTransaction, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response RemoveMoneyOrder(long customerSessionId, long moneyOrderId, bool isParkedTransaction, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response RemoveMoneyTransfer(long customerSessionId, long moneyTransferId, bool isParkedTransaction, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response RemoveCashIn(long customerSessionId, long cashId, MGIContext mgiContext);
		...
		[OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ShoppingCart(long customerSessionId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response Checkout(long customerSessionId, decimal cashToCustomer, string cardNumber, ShoppingCartCheckoutStatus shoppingCartstatus, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response GenerateReceiptsForShoppingCart(long customerSessionId, long shoppingCartId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response CloseShoppingCart(long customerSessionId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ParkCheck(long customerSessionId, long checkId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ParkFunds(long customerSessionId, long fundsId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ParkBillPay(long customerSessionId, long billPayId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ParkMoneyTransfer(long customerSessionId, long moneyTransferId, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
		Response ParkMoneyOrder(long customerSessionId, long moneyOrderId, MGIContext mgiContext);
        #endregion
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		[OperationContract]
		Response ReSubmitCheck(long customerSessionId, long checkId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		[OperationContract]
		Response ReSubmitMO(long customerSessionId, long moneyOrderId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		[OperationContract]
		Response IsReferralApplicable(long customerSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response PostFlush(long customerSessionId, MGIContext mgiContext);

		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response RemoveCheckFromCart(long customerSessionId, long checkId, MGIContext mgiContext);

        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        Response GetAllParkedShoppingCartTransactions();
    }
}
