...
namespace MGI.Core.Partner.Impl
{
	public class MessageCenterImpl : IMessageCenter
	{
		...
		public bool Create(AgentMessage agentMessage, string timezone)
		{
			...
			{
				throw new MessageCenterException(MessageCenterException.AGENT_MESSAGE_CREATE_FAILED, ex);
			}
		}
		...
		public bool Update(AgentMessage agentMessage)
		{
			...
			{
				throw new MessageCenterException(MessageCenterException.AGENT_MESSAGE_UPDATE_FAILED, ex);
			}
		}
		...
		public AgentMessage Lookup(Transaction transaction)
		{
			...
			{
				throw new MessageCenterException(MessageCenterException.AGENT_MESSAGE_LOOKUP_FAILED, ex);
			}
		}
