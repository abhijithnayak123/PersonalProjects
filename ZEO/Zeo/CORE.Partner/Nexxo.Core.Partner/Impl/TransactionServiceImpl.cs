	...
	public class TransactionServiceImpl<T> : ITransactionService<T> where T:Transaction
	{
		...
		public void Create( T transaction )
		{
            ...
            catch (Exception ex)
			{
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_CREATE_FAILED, ex);
            }
		}
		...
		public T Lookup( long Id )
		{
            ...
            { 
				...
				throw new TransactionServiceException(TransactionServiceException.TRANSACTION_NOT_FOUND);
            }
		...
		public void UpdateStates( long Id, int CXEState, int CXNState, string description = "" )
		{
            ...
            catch (Exception ex)
			{
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_STATES_FAILED, ex);
            }
		}
		...
		public void UpdateCXEStatus(long Id, int CXEStatus)
		{
            ...
            catch (Exception ex)
			{
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_CXE_STATE_FAILED, ex);
            }
		}
		...
		public void UpdateCXNStatus(long Id, int CXNStatus)
		{
            ...
            catch (Exception ex)
			{
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_CXN_STATE_FAILED, ex);
            }
		}
		...
		public void UpdateFee(long Id, decimal Fee)
		{
            ...
            catch (Exception ex)
            {
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_FEE_FAILED, ex);
            }
		}
        ...
        public void UpdateTransactionDetails(long Id, int CXEState, int CXNState, string ConfirmationNumber, int Type)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_TRANSACTIONDETAILS_FAILED, ex);
            }
        }
        ...
        public void UpdateAmount(long Id, decimal amount)
        {
            ...
            catch (Exception ex)
            {
				...
				throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_AMOUNT_FAILED, ex);
            }
        }
		...
		public void Update(T txn)
		{
			...
			catch (Exception ex)
			{
				...
				throw new TransactionServiceException(TransactionServiceException.TRANSACTION_UPDATE_FAILED, ex);
			}
		}
