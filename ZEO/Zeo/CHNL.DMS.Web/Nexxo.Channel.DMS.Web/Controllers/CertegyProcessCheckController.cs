...
//			Session["MicrErrorCount"] = null;
//			Response checkTyperesponse = new Response();
...
//			checkTyperesponse = desktop.GetCheckTypes(customerSessionId, mgiContext);
//			if (WebHelper.VerifyException(checkTyperesponse)) throw new AlloyWebException(checkTyperesponse.Error.Details);
//			checkAmount.LCheckTypes = checkTyperesponse.Result as List<SelectListItem>;
