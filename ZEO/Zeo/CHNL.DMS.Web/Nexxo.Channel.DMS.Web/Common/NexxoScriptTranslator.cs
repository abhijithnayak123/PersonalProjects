...
{
    public class NexxoScriptTranslator : IHttpHandler
    {
        ...
        private static Regex REGEX = new Regex(@"_NexxoTranslate\(([^\))]*)\)", RegexOptions.Singleline | RegexOptions.Compiled);
        ...
        private string TranslateScript(string text)
        {
            ...
            ResourceManager manager = new ResourceManager(typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo));
            ...
            foreach (Match match in matches)
            {
                ...
                if (obj != null)
                {
                    text = text.Replace(match.Value, HttpUtility.JavaScriptStringEncode(obj.ToString()));
                }
            }
        ...
        private System.Web.Routing.RequestContext requestContext { get; set; }

        public NexxoScriptTranslator() : base() { }

        public NexxoScriptTranslator(System.Web.Routing.RequestContext requestContext)
        {
