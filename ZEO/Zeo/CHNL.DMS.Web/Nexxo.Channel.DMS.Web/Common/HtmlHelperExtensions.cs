...
namespace Nexxo.HtmlHelpers
{
    public static class Extensions
    {
        ...
        public static MvcHtmlString ParseHTMLTags(this HtmlHelper helper, string value)
        {
            return new MvcHtmlString(value.Replace(@"\u003c", "<").Replace(@"\u003e", ">").Replace(@"\u0026","&"));
        }

        public static MvcHtmlString ParseJsonForMultiSelect(this HtmlHelper helper, string value)
        {
            return new MvcHtmlString(value.Replace("Selected", "checked").Replace("Text", "name").Replace("Value", "value"));
        }
    }
}