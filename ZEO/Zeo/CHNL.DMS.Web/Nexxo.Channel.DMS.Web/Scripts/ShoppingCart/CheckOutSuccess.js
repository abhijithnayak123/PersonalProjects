...
//Starts Here
function finalFlushCall() {
	$.ajax({
		type: 'GET',
        url: FinalFlushCallURL,
		async: false,
		datatype: 'json',
...
function preparePrintList(receiptsListGlb) {
    ...
    $('<tr><td style="position:absolute;float: left; margin-left: 35%; text-align: left; padding-top: 3%; padding-right: 3%; padding-bottom: 3%; padding-left: 3%;" colspan="4"><div id="btndivs" class="SrchButtonWdth SrchButtonWdths" style=""><a id="linkbtn" class="anc_link_btn done_button" style="visibility:hidden;background-color: rgb(0, 105, 55);" href="' + CustomerSearchURL + '" tabIndex="1">Done</a></div></td></tr>').appendTo('#ReceiptsTable');
...
function prepareForSend() {  
    ...
    if (typeof receiptsListGlb[parseInt(currentReceipt)] == "undefined" || (currentReceipt >= receiptsListGlb.length)) {
        $('.done_button').removeClass('DisableButtons');
