...
namespace TCF.Channel.Zeo.Web.Models
{
    ...
    public class WesternUnionBillPayViewModel : BillPaymentViewModel
    {
        ...
        /// </summary>
        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "DeliveryMethod")]
        ...
        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "BillPayeeAttention")]
        public string Attention { set; get; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "BillPayeeReference")]
        public string Reference { set; get; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "BillPayeeAccountHolderName")]
        public string AccountHolder { set; get; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "BillPayeeAvailableBalance")]
        public string AvailableBalance { set; get; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "BillPayeeDateOfBirth")]
