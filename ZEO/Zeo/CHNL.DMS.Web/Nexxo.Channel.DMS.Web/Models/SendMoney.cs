...
namespace TCF.Channel.Zeo.Web.Models
{
    public class SendMoney : BaseModel
	{
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyCity")]
		...
		[RegularExpression(@"^[0-9]*((\.[0-9]{2})|(\.[0-9]{1}))?$", ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "BillAmountCashRegularExpression")]
		...
		[RegularExpression(@"^[0-9]*((\.[0-9]{2})|(\.[0-9]{1}))?$", ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "BillAmountCashRegularExpression")]
		[Range(typeof(Decimal), "0.01", "999999999.99", ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyAmountRegularExpression")]
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "ActOnMyBehalf")]
		public string ActOnMyBehalf { get; set; }

		// This has been added for User Story # US1956 - Complete

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyDeliveryOptions")]
		public string DeliveryOptions { get; set; }

		public string ReceiverName { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyTestQuestion")]
		[ConditionalTestQuestion("TestQuestionOption", ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyTestQuestionRequired")]
		...
		[ConditionalTestQuestion("TestQuestionOption", ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyTestAnswerRequired")]
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyTotalAmount")]
		[Required(ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyTotalAmountRequired")]
		...
		public List<ZeoClient.Receiver> FrequentReceivers { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "ConsumerProtectionMessage")]
		public bool ConsumerProtectionMessage { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "ProvidedTermsandConditonsMessage")]
		public bool ProvidedTermsandConditonsMessage { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "DoddFrankTermsandConditonsMessage")]
		public bool DoddFrankDisclosure { get; set; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "DomesticPreDisclosureMessage")]
        public bool DomesticPreDisclosure { get; set; }

        public decimal DestinationAmountFromFeeEnquiry { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "PickupLocation")]
		public string PickUpLocation { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "PickupMethod")]
		public string PickUpMethod { get; set; }

		[Required(ErrorMessage = "PickUp Method is required.")]
		public string PickUpMethodId { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "PickupOptions")]
		public string PickUpOptions { get; set; }

		[Required(ErrorMessage = "PickUp Options is required.")]
		public string PickUpOptionsId { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneySearchForReceiver")]
		...
		[StringLength(966, ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "SendMoneyPersonalMessageStringLength")]
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyPersonalMessage")]
		public string PersonalMessage { get; set; }
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyMessageFee")]
        ...
        public bool IsFraudCheck { get; set; }
