...
namespace TCF.Channel.Zeo.Web.Models
{
    public class CheckAmount : CheckDetails
    {
        ...
        public IEnumerable<SelectListItem> LPromotionCodes { get; set; }
        ...
        //public bool IsCheckTypeEditable { get; set; }

        //Created a hidden field because for OnUS Check type will be disabled and the value will not be posted to the 
        //server if the Dropdown is disabled.
        public string OnUSCheckType { get; set; }
    }
}