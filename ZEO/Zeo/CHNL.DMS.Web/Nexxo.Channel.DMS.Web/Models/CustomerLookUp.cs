...
namespace TCF.Channel.Zeo.Web.Models
{
    ...
    public class CustomerLookUp : BaseModel
    {
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "AccountNo")]
		public string AccountNumber { get; set; }

		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "CardNo")]
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "Appl")]
