...
namespace TCF.Channel.Zeo.Web.Models
{
    ...
    {
        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "MGramRMReferenceNumber")]
        [StringLength(8, ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "MGramRMReferenceNumberStringLength", MinimumLength = 8)]
        [Required(ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), ErrorMessageResourceName = "MGramRMReferenceNumberRequired")]
        ...
        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "RecieveMoneyReceiveAmount")]
