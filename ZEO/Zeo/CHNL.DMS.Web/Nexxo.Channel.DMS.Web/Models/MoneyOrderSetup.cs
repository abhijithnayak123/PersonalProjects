...
namespace TCF.Channel.Zeo.Web.Models
{
    public class MoneyOrderSetup : BaseModel
    {
        ...
        public MoneyOrderSetup()
        {
            LPromotionCodes = new List<SelectListItem>()
            {
		...
		[Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "PromotionDescription")]
