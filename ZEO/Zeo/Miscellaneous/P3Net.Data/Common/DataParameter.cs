...
namespace P3Net.Data.Common
{
    ...
    public class DataParameter
    {
        ...
        public int Precision
        {
            ...
            set
            {
                switch (DbType)
                {
                    ...
                    {
                        if (value < 0 || value > 24)
                            throw new ArgumentOutOfRangeException("value", "Precision must be between 0 and 24.");
                        break;
                    };
                    case DbType.Double:
                    {
                        if (value < 0 || value > 53)
                            throw new ArgumentOutOfRangeException("value", "Precision must be between 0 and 53.");
                        break;
                    };
                    default:
                    {
                        if (value < 0 || value > 38)
                            throw new ArgumentOutOfRangeException("value", "Precision must be between 0 and 38.");
                        break;
                    };
                };
        ...
        public int Scale
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentOutOfRangeException("value", "Scale must be greater than 0.");
        ...
        public int Size
        {
            ...
            {
                if (value < -1)
                    throw new ArgumentOutOfRangeException("value", "Size must be greater than or equal to 0.");
