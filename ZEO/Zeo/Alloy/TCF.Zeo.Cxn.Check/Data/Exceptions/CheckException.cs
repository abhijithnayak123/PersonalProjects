...
namespace TCF.Zeo.Cxn.Check.Data.Exceptions
{
    public class CheckException : ZeoException
	{
        ...
        //Teller Inquiry Changes
        public static string CERIFICATE_NOTFOUND = "2024";
        public static string TELLERINQUIRY_FAILED = "2025";
        public static string TELLERINQUIRYNONSUFFICIENT_FUNDS = "2026";
        public static string TELLERINQUIRYACCOUNT_STOPS = "2027";
        public static string TELLERINQUIRYACCOUNT_CAUTION = "2028";
        public static string TELLERINQUIRYFLAGGEDFORNO_POSTING = "2029";
        public static string TELLERINQUIRYFLAGGEDFORNO_DEBITS = "2030";
        public static string TELLERINQUIRYNO_ACCOUNT = "2031";
        public static string TELLERINQUIRYACCOUNT_CLOSED = "2032";
        public static string TELLERINQUIRYACCOUNT_DORMANT = "2033";
    }
}
