...
-- Description: inserting the error details when no customer found.
-- ================================================================================
...
(
   N'1001.100.6018',
	1,
	N'0',
	N'<span>No customer found with your current search. Click &quot;Cancel&quot; to retry your search with different search options.</span><br /><center>OR</center><span> Click &quot;Continue&quot; to register your customer as new.</span>',
	GETDATE(),
	N'Zeo',
	2,
