...
BEGIN
	...
	INSERT INTO tTxn_FeeAdjustments
		(PromotionId, TransactionId, IsActive, DTServerCreate ,DTTerminalCreate ,DTTerminalLastModified ,DTServerLastModified, CustomerId, ProductId)
	VALUES
		(@PromotionId, @TransactionId, @IsActive, @DTServerCreate, @DTTerminalCreate, NULL, NULL, @CustomerId, @TransactionType)
