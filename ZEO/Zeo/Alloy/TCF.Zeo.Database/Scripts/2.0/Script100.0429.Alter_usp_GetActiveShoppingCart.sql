...
-- Description: Altered the script to add the refund transaction to the tShoppingCart and tShoppingCartTransactions table 
--				We need to avoid refund commited transaction showing up in shooping cart, 
--				So checking if Transaction type 3(SendMoneyRefund) then we are not showing the transaction in shopping cart
-- ================================================================================
