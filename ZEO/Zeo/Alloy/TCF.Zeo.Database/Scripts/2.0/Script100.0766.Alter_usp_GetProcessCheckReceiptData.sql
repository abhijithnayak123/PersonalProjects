...
BEGIN
     BEGIN TRY
             SELECT 
	               ...
	               tCTs.DisplayName					AS ReturnType,
            ...
            FROM 
			      tTxn_Check tTC WITH (NOLOCK)   
					LEFT JOIN tChxr_Trx tCT WITH (NOLOCK)						ON tTC.CXNId = tCT.ChxrTrxID 
					LEFT JOIN tTCFOnus_Trx ttt WITH (NOLOCK)					ON tTC.CXNId = ttt.TCFOnusTrxID 
