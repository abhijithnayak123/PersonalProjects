...
(
	...
	SPACE(3),CHAR(149),' Find customer record in RCIF and locate account number.',CHAR(13) + CHAR(10),
	SPACE(3),CHAR(149),' Search ZEO by TCF account number and continue with registration.',CHAR(13) + CHAR(10),
	'NOTE: If updates are needed to the RCIF profile, refer to the ZEO procedures on ', QUOTENAME('Updating the Customer Profile',''''),'.')
)
