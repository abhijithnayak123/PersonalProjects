...
-- Modified Reason: Multiple records were adding for Send Money product because we were not checking the ProductId while getting the Promotions and WU provider is 
--  common for Send Money and Receive Money. 
-- Jira ID:		<B-12321>
-- ================================================================================
...
BEGIN
	...
	FROM 
		...
		LEFT JOIN tProductProcessorsMapping tppm WITH (NOLOCK) ON tppm.Code = p.ProviderId AND tppm.ProductId = p.ProductId
