		      ...
		      END								                               AS SenderMobileNumber,
                    ...
                    CONCAT(ISNULL(tWT.RecieverFirstName, ''),' ',
						   ...
						   ISNULL(tWT.RecieverSecondLastName, ''))
										                                       AS ReceiverName,
                    tWT.Address								                   AS ReceiverAddress,
                    tWT.City								                   AS ReceiverCity,
                    tWT.[State/Province]					                   AS ReceiverState,
                    tWT.ZipCode								                   AS ReceiverZip,
                    tWT.ReceiverPhoneNumber							           AS ReceiverPhoneNumber,
