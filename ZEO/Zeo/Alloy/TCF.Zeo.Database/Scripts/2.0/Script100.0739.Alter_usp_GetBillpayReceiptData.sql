...
-- Modified Reason : Defect Fix - Customer Account Number is less than 4 digits throws up an error. 
...
BEGIN  
     BEGIN TRY
			...
			CASE 
				WHEN LEN(Customer_AccountNumber) < 4
				THEN '000' + Customer_AccountNumber
				ELSE Customer_AccountNumber 
