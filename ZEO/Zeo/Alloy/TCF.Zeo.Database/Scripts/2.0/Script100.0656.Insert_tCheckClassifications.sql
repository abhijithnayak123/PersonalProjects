...
,(@onUsTRUECheckTypeId, 107006444, 107006444, NULL, NULL, 10,@stateCodeAZ, GETDATE())
,(@onUsTRUECheckTypeId, 122106183, 122106183, NULL, NULL, 10,@stateCodeIL, GETDATE())
,(@onUsTRUECheckTypeId, 271972572, 271972572, NULL, NULL, 10,@stateCodeMI, GETDATE())
,(@onUsTRUECheckTypeId, 272471548, 272471548, NULL, NULL, 10,@stateCodeWI, GETDATE())
,(@onUsTRUECheckTypeId, 275071385, 275071385, NULL, NULL, 10,@stateCodeMN, GETDATE())