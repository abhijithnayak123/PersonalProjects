...
-- Modifications : Getting the Provider Id if the transaction is "Check".
-- Jira ID:		AL-9009
-- ================================================================================
...
BEGIN
	BEGIN TRY
		...
		FROM tShoppingCarts sc
			...
			LEFT JOIN tTxn_Check tc ON sct.TransactionId = tc.TransactionID AND sct.ProductId = 1 -- If Check Trx Get the Provider Id.
