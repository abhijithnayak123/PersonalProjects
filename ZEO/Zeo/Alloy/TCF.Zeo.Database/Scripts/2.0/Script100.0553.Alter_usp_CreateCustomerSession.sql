...
-- Description:	Modified the SP to get the cart Id if there is any unpark tarnsactions
-- ================================================================================
...
BEGIN
	...
	EXEC usp_UnParkShoppingCart @customerSessionId, @customerId, @cartId OUTPUT
