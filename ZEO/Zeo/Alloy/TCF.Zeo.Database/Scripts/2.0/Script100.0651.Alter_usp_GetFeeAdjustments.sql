...
BEGIN
	BEGIN TRY
		...
		SELECT 
			cpf.DTStart, cpf.FeeAdjustmentId, cpf.TransactionType, cpf.Name, cpf.Description, cpf.SystemApplied, cpf.AdjustmentRate, cpf.AdjustmentAmount, cpf.PromotionType, cpf.ChannelPartnerId, cpf.Priority, cpf.IsOverridable
		FROM 
