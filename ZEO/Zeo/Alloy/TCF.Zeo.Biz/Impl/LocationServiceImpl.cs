    ...
    public class LocationServiceImpl : ILocationService
    {
        ...
        public LocationServiceImpl()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<coreData.MasterData, MasterData>();
                cfg.CreateMap<coreData.MasterData, MasterData>().ReverseMap();
            });
        ...
        public List<MasterData> GetStateNamesAndIdByChannelPartnerId(commonData.ZeoContext context)
        {
            try
            {
                using (_LocationserviceImpl = new CoreImpl.ZeoCoreImpl())
                {
                    List<coreData.MasterData> coreStateNameByChannelPartnerId = _LocationserviceImpl.GetStateNameAndIdByChannelPartnerId(context);
                    return mapper.Map<List<coreData.MasterData>, List<MasterData>>(coreStateNameByChannelPartnerId);
                }
            }
            catch (Exception ex)
            {
                if (ExceptionHelper.IsExceptionHandled(ex)) throw;
                throw new LocationException(LocationException.LOCATION_STATE_NAME_GET, ex);
            }
        }
    }
}
