...
namespace TCF.Zeo.Cxn.MoneyTransfer.Data.Exceptions
{
    public class MoneyTransferException : ZeoException
    {
        ...
        public static string MONEYTRANSFER_GETFRAUDLIMIT_FAILED                     = "2088";
        public static string MONEYTRANSFER_DESTINATIONAMOUNT_FAILED                 = "2089";
        public static string MONEYTRANSFER_COUNTRY_IS_BLOCKED                       = "2090";
        public static string GET_UNBLOCKED_COUNTRIES_FAILED                         = "2091";
    }
}
