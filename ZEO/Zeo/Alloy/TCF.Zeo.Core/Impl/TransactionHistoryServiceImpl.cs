    ...
    public class TransactionHistoryServiceImpl : ITransactionHistoryService
    {
        public List<TransactionHistory> GetAgentTransactionHistory(TransactionSearchCriteria searchCriteria, ZeoContext context)
        {
            try
            {
                ...
                coreTrxProcedure.WithParameters(InputParameter.Named("startDate").WithValue(searchCriteria.StartDate));
                coreTrxProcedure.WithParameters(InputParameter.Named("endDate").WithValue(searchCriteria.EndDate));
