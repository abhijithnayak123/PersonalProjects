...
namespace TCF.Zeo.Core.Data.Exceptions
{
    public class MoneyTransferException : ZeoException
    {
        ...
        public static readonly string GET_BLOCKED_UNBLOCKED_COUNTRIES_FAILED = "1008";
        public static readonly string INSERT_BLOCKED_COUNTRIES_FAILED = "1009";
        public static readonly string GET_UNBLOCKED_COUNTRIES_FAILED = "1010";
    }
}
