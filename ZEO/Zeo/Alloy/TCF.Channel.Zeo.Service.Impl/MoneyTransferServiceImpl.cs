...
namespace TCF.Channel.Zeo.Service.Impl
{
    public partial class ZeoServiceImpl : IMoneyTransferService
    {
        ...
        public Response GetFraudLimit(string countryCode, ZeoContext context)
        {
            ...
            BizmoneytrService = new MoneyTransferEngineImpl();
            response.Result = BizmoneytrService.GetFraudLimit(countryCode, commonContext);
            return response;
        }
        ...
        public Response GetDestinationAmount(FeeRequest feeRequest, ZeoContext context)
        {
            ...
            Response response = new Response();
            BizmoneytrService = new MoneyTransferEngineImpl();
            response.Result = BizmoneytrService.GetDestinationAmount(feeRequest, commonContext);
        ...
        public Response GetBlockedUnBlockedCountries(ZeoContext context)
        {
            ...
            Response response = new Response();
            BizmoneytrService = new MoneyTransferEngineImpl();
            response.Result = BizmoneytrService.GetBlockedUnBlockedCountries(commonContext);
        ...
        public Response SaveBlockedCountries(List<string> blockedCountries, ZeoContext context)
        {
            ...
            Response response = new Response();
            BizmoneytrService = new MoneyTransferEngineImpl();
            response.Result = BizmoneytrService.SaveBlockedCountries(blockedCountries, commonContext);
