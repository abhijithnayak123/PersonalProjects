...
namespace TCF.Channel.Zeo.Service.Impl
{
    ...
    public Response GetSupportInformation(Data.ZeoContext context)
        {
            commonData.ZeoContext commonContext = mapper.Map<commonData.ZeoContext>(context);
            ...
            result.Result = bizChannelPartnerService.GetSupportInformation(commonContext);

            return result;
        }

 public Response GetProductProviderDetails(ZeoContext context)
        {
            commonData.ZeoContext commonContext = mapper.Map<commonData.ZeoContext>(context);
            ...
            ChannelPartnerServiceImpl bizChannelPartnerService = new ChannelPartnerServiceImpl();
            result.Result = bizChannelPartnerService.GetProductProviders(commonContext);
