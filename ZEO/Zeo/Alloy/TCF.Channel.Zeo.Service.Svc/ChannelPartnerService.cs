...
namespace TCF.Channel.Zeo.Service.Svc
{
    public partial class ZeoService : IChannelPartnerService
    {
        ...
        public Response GetSupportInformation(ZeoContext context)
        {
            return serviceEngine.GetSupportInformation(context);
        }
        public Response GetProductProviderDetails(ZeoContext context)
        {
            return serviceEngine.GetProductProviderDetails(context);
        }
    }
}