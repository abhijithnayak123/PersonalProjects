...
namespace TCF.Channel.Zeo.Service.Contract
{
    ...
    public interface IMoneyTransferService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(CommonData.ZeoSoapFault))]
        Response GetFraudLimit(string countryCode, ZeoContext context);

        [OperationContract]
        [FaultContract(typeof(CommonData.ZeoSoapFault))]
        Response GetDestinationAmount(FeeRequest feeRequest, ZeoContext context);

        [OperationContract]
        [FaultContract(typeof(CommonData.ZeoSoapFault))]
        Response GetBlockedUnBlockedCountries(ZeoContext context);

        [OperationContract]
        [FaultContract(typeof(CommonData.ZeoSoapFault))]
        Response SaveBlockedCountries(List<string> blockedCountries, ZeoContext context);
    }
}
