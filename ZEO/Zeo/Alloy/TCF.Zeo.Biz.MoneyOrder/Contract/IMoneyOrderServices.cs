...
namespace TCF.Zeo.Biz.MoneyOrder.Contract
{
    public interface IMoneyOrderServices
    {
        ...
        /// <returns></returns>
        List<TransactionFee> GetMoneyOrderFee(decimal amount, CommonData.ZeoContext context);
        ...
        TransactionFee GetFeeBasedOnPromoCode(decimal amount, string promoCode, CommonData.ZeoContext context);
    }
}
