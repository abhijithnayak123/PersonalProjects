...
namespace TCF.Zeo.Biz.Common.Data.Exceptions
{
    public class MoneyTransferException : ZeoException
    {
        ...
        public static readonly string MONEYTRANSFER_FRAUDLIMIT_FAILED                               = "6043";
        public static readonly string MONEYTRANSFER_DESTINATIONAMOUNT_FAILED                        = "6044";
        public static readonly string GET_BLOCKED_UNBLOCKED_COUNTRIES_FAILED                        = "6045";
        public static readonly string SAVE_BLOCKED_COUNTRIES_FAILED                                 = "6046";
    }
}
