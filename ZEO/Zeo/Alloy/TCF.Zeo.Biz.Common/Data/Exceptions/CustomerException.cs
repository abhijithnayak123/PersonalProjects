...
namespace TCF.Zeo.Biz.Common.Data.Exceptions
{
    public class CustomerException : ZeoException
    {
        ...
        public static readonly string NO_CUSTOMERS_FOUND = "6018";
        public static readonly string CUSTOMER_ZEOCARD_VALIDATION_FAILED = "6019";
        public static readonly string CUSTOMER_ZEOCARD_DETAILS_NOT_MATCHING = "6020";
    }
}
