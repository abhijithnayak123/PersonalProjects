...
DECLARE @tcfChannelPartnerID BIGINT = 34
 ...
 --INSERT Card replacement fee as '5' for Synovus
...
WHERE FT.Name = 'Card Replacement Fee' AND FM.ChannelPartnerID = @synovusChannelPartnerID
...
END
 ...
 --INSERT Card replacement fee as '0' for TCF

SELECT @channelPartnerFeeTypePK = ChannelPartnerFeeTypeMappingPK 
FROM tVisa_ChannelPartnerFeeTypeMapping FM INNER JOIN tVisa_FeeTypes FT ON FM.VisaFeeTypePK = FT.VisaFeeTypePK
WHERE FT.Name = 'Card Replacement Fee' AND FM.ChannelPartnerID = @tcfChannelPartnerID
