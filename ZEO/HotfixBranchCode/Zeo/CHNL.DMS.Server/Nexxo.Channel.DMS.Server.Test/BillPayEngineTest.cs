...
namespace MGI.Channel.DMS.Server.Test
{
	...
	public class BillPayEngineTest : AbstractTransactionalSpringContextTests
	{
		...
		public void BillerSearchTest()
		{
            ...
            List<string> BillerList = DeskTopTest.GetBillers(0, channelPartnerID, searchTerm, mgiContext);
			Assert.AreNotEqual(BillerList, null);
			Assert.Less(BillerList.Count, 7);
		}
		...
		public void FrequentBillerTest()
		{
            ...
            List<Product> billerList = DeskTopTest.GetFrequentBillers(0, customer.AlloyID, mgiContext);
			Assert.AreNotEqual(billerList, null);
