...
namespace MGI.Channel.DMS.Server.Contract
{
    ...
    public interface IDataStructuresService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        List<string> Cities(long agentSessionId, string state, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        IDRequirement IdRequirements(long agentSessionId, long channelPartnerId, string country, string idType, string idState, MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        List<string> MobileProviders(long agentSessionId, MGIContext context);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        List<String> ProfileStatus(long agentSessionId, MGIContext mgiContext);
