...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface INpsTerminalService
	{
		...
		bool CreateNpsTerminal(long agentSessionId, NpsTerminal psTerminal, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		bool UpdateNpsTerminal(long agentSessionId, NpsTerminal psTerminal, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		NpsTerminal LookupNpsTerminal(long agentSessionId, long Id, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		NpsTerminal LookupNpsTerminal(long agentSessionId, string ipAddress, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		NpsTerminal LookupNpsTerminal(long agentSessionId, string name, ChannelPartner channelPartner, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		List<NpsTerminal> LookupNpsTerminalByLocationID(long agentSessionId, long locationId, MGIContext mgiContext);
