...
-- Description:	<Script to alter trigger tTxn_MoneyTransfer_CommitAudit>           
-- Jira ID:	<AL-243>
--===========================================================================================

/****** Object:  Trigger [dbo].[tTxn_MoneyTransfer_CommitAudit]    Script Date: 3/30/2015 4:02:48 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER TRIGGER [dbo].[tTxn_MoneyTransfer_CommitAudit] ON [dbo].[tTxn_MoneyTransfer_Commit] AFTER INSERT, UPDATE, DELETE
AS
       SET NOCOUNT ON
