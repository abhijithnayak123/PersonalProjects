...
namespace MGI.Cxn.Customer.FIS.Impl
{
	public class FISGateway : IClientCustomerService
	{
		...
		public long Add(CustomerProfile customer, MGIContext mgiContext)
		{
			...
			customerAccountDetails.BranchId = (string.IsNullOrWhiteSpace(fisAccountDetails.BranchId) && string.IsNullOrWhiteSpace(fisAccountDetails.BankId)) && mgiContext.BranchId != 0 ? mgiContext.BranchId.ToString("D4") : fisAccountDetails.BranchId;
		...
		public long AddCXNAccount(CustomerProfile customer, MGIContext mgiContext)
		{
			...
			fisAccountDetails.BranchId = (string.IsNullOrWhiteSpace(fisAccountDetails.BranchId) && string.IsNullOrWhiteSpace(fisAccountDetails.BankId)) && mgiContext.BranchId != 0 ? mgiContext.BranchId.ToString("D4") : fisAccountDetails.BranchId;
