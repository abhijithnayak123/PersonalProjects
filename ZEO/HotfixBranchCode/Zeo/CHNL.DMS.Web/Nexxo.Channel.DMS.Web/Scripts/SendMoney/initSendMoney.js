...
$(document).ready(function () {
            ...
            var selectedReceiverId = $('#ReceiverID').val();        
               $.ajax({
                    ...
                    success: function (data) {                   
                        if (data) {
                            showExceptionPopupMsg("MGiAlloy | 0.0 | Phone notification delivery option requires receiver contact details | Click on Edit Receiver and update receiver details to continue");
    ...
    $("#continueButton").click(function (event) {  
        ...
        if ($('#ActOnMyBehalf').val() == "0") {
        	showExceptionPopupMsg("MGiAlloy | 1003.6002 | Please answer question | Please answer question");
            event.preventDefault();
        }
    });
    $("#ActOnMyBehalf").change(function () {
        ...
        if (this.value == '1') {
            ...
            showExceptionPopupMsgForActOnMyBehalf("MGiAlloy | 1003.6002 | Third Party Send Money Transactions are not allowed in the application. Transaction cannot be set up. | Customer can contact Western Union at 1-800-325-6000 for further inquiries.");
            $('#continueButton').prop("disabled", true);
            $('#continueButton').css("background-color", "##808080");
...
function SubmitForm() {
    ...
    if (firstName == '' && lastName == '' && deliveryMethod == '' && country == '') {
...
$(document).ready(function () {
    ...
    $('#DestinationAmount').blur(function () {
        ...
        else if ($('#DestinationAmount').val() != '' && selectedReceiverId != 0) {
            $('#continueButton').prop("disabled", false);
            $('#continueButton').css("background-color", "#006937");
        }
    ...
    $('#DestinationAmount').keyup(function (e) {
