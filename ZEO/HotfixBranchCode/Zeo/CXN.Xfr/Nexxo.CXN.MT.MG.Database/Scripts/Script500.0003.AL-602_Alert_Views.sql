...
AS
	...
	WHERE 
		MGTransferTrxID = (SELECT MGTransferTrxID FROM inserted)
             
   IF ((SELECT COUNT(*) FROM inserted)<>0 AND (SELECT COUNT(*) FROM deleted)>0)
   BEGIN
		INSERT INTO tMGram_Transfer_Trx_Aud(
	   [MGTransferTrxPK],[MGTransferTrxId] ,[Amount] ,[FeeAmount] ,[DestinationCountry] ,[DestinationState]  ,[DeliveryOption]  ,[SenderFirstName]
      ...
      ,[ReceiveAmount],[DTTerminalCreate],[DTTerminalLastModified],[DTServerCreate] ,[DTServerLastModified]  ,[EstimatedReceiveAmount],[EstimatedExchangeRate]
	  ...
	  ,[RefundFaceAmount]
	  ,[RefundFeeAmount]
	  ,[IsTestQusAndAnsRequired]
	  ,[IsReceiverHasPhotoId]
	  ,[ReceiverNickName]
	  )
       
       SELECT	[MGTransferTrxPK],[MGTransferTrxId] ,[Amount] ,[FeeAmount] ,[DestinationCountry] ,[DestinationState]  ,[DeliveryOption]  ,[SenderFirstName]
      ,[SenderLastName]    ,[SenderAddress] ,[SenderCity] ,[SenderState]  ,[SenderZipCode]  ,[SenderCountry]  ,[SenderHomePhone]
      ,[ReceiverFirstName]  ,[ReceiverLastName],[ReceiverCountry],[PrimaryReceiptLanguage]  ,[SecondaryReceiptLanguage]
      ,[PromoCodeValues_PromoCode] ,[GrossTotalAmount],[TransactionType] ,[ChannelPartnerId],[ProviderId],[MgiTransactionSessionId]
      ,[ExchangeRate],[PromotionDiscount],[PromotionErrorCodeMessage_PrimaryLanguage] ,[PromotionErrorCode],[TaxAmount]
   ...
   BEGIN
       INSERT INTO tMGram_Transfer_Trx_Aud( [MGTransferTrxPK],[MGTransferTrxId] ,[Amount] ,[FeeAmount] ,[DestinationCountry] ,[DestinationState]  ,[DeliveryOption]  ,[SenderFirstName]
      ,[SenderLastName]    ,[SenderAddress] ,[SenderCity] ,[SenderState]  ,[SenderZipCode]  ,[SenderCountry]  ,[SenderHomePhone]
      ,[ReceiverFirstName]  ,[ReceiverLastName],[ReceiverCountry],[PrimaryReceiptLanguage]  ,[SecondaryReceiptLanguage]
      ,[PromoCodeValues_PromoCode] ,[GrossTotalAmount],[TransactionType] ,[ChannelPartnerId],[ProviderId],[MgiTransactionSessionId]
      ,[ExchangeRate],[PromotionDiscount],[PromotionErrorCodeMessage_PrimaryLanguage] ,[PromotionErrorCode],[TaxAmount]
