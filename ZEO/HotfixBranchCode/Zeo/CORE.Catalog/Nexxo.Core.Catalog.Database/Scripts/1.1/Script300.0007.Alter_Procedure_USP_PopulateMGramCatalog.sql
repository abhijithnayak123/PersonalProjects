...
BEGIN
	...
	SET @QUERY = @QUERY + ' INSERT INTO tMasterCatalog (ROWGUID,PROVIDERCATALOGID, BillerName,ChannelPartnerId,ProviderId,IsActive,DtCreate,BillerCode,Keywords)  
	...
	INSERT INTO tPartnerCatalog (rowguid, id, BillerName, ChannelPartnerId,ProviderId,DtCreate,BillerCode,Keywords) 
	SELECT  NEWID(), id, BillerName , ChannelPartnerId, PROVIDERID,GETDATE(),BillerCode,Keywords
