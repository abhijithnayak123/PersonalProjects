...
namespace MGI.Core.Partner.Impl
{
	public class FeeAdjustmentServiceImpl : IFeeAdjustmentService
	{
		...
		// AL-591: The below methos is introduced to Soft delete feeadjustment ny using IsActive Status in tTxn_FeeAdjustments, this issue occured as in ODS Report 
		//we found duplicate transactions and the reason was tTxn_FeeAdjustments table having duplicate records
		// Developed by: Sunil Shetty || 03/07/2015
