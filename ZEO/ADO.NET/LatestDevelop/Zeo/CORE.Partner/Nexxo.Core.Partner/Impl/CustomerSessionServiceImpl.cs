...
namespace MGI.Core.Partner.Impl
{
    public class CustomerSessionServiceImpl : ICustomerSessionService
    {
        ...
        public ShoppingCart GetParkingShoppingCart(CustomerSession customerSession)
        {
            ...
            {
                MongoDBLogger.Error(customerSession, "GetParkingShoppingCart", AlloyLayerName.CORE, ModuleName.ShoppingCart,
                           "Error in GetParkingShoppingCart - MGI.Core.Partner.Impl.CustomerSessionServiceImpl", ex.Message, ex.StackTrace);

                throw new ShoppingCartServiceException(ShoppingCartServiceException.GET_SHOPPINGCART_PARKED_ITEM_FAILED, ex);
            }
