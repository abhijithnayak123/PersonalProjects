...
namespace MGI.Core.Partner.Impl
{
    public class TerminalServiceImpl : ITerminalService
    {
        ...
        public Terminal Lookup(long Id)
        {
            ...
            {
				throw new PartnerTerminalException(PartnerTerminalException.TERMINAL_GET_FAILED, ex);
            }
        }
        ...
        public Guid Create(Terminal terminal)
        {
            ...
            {
				throw new PartnerTerminalException(PartnerTerminalException.TERMINAL_CREATE_FAILED, ex);
            }
        }
        ...
        public bool Update(Terminal terminal)
        {
            ...
            {
				throw new PartnerTerminalException(PartnerTerminalException.TERMINAL_UPDATE_FAILED, ex);
            }
        }
