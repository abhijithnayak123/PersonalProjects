...
--				<Script to alter transaction history to get the transaction details for Money Order check #>
--				<Script to alter transaction history to get the transaction details for Companion Card Order.>
-- Jira ID:	<AL-4485>
-- =============================================================================

IF EXISTS (SELECT name FROM sys.views
   WHERE name = 'vTransactionHistory')
BEGIN
...
FROM  
	...
	LEFT JOIN sCustomer sCC on tF.AddOnCustomerId = sCC.CustomerID
WHERE   
