...
namespace MGI.Biz.MoneyTransfer.Test
{
	...
	public class MoneyTransferEngineTest : BaseClass_Fixture
	{
		...
		[Test]
		public void Can_Validate_Money_Transfer_without_Occupation()
		{
		...
		[Test]
		public void Can_Commit_Receive_Money_Transfer()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF", SMTrxType = "" };
			long ptrnTransactionId = 1000000010;

			int id = BIZMoneyTransferEngine.Commit(customerSessionId, ptrnTransactionId, mgiContext);

			Assert.AreEqual(id, (int)CXEData.TransactionStates.Committed);
			CXEMoneyTransferService.Verify(moq => moq.Commit(It.IsAny<long>()), Times.AtLeastOnce());
			CXEMoneyTransferService.Verify(moq => moq.Update(It.IsAny<long>(), It.IsAny<CXEData.TransactionStates>(), It.IsAny<string>()), Times.AtLeastOnce());
			CXNMoneyTransferService.Verify(moq => moq.Commit(It.IsAny<long>(), It.IsAny<MGIContext>()), Times.AtLeastOnce());
		}

		[Test]
		public void Can_Commit_Refund_Money_Transfer()
		{
			long customerSessionId = 1000000003;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF", SMTrxType = "" };
			long ptrnTransactionId = 1000000011;

			int id = BIZMoneyTransferEngine.Commit(customerSessionId, ptrnTransactionId, mgiContext);

			Assert.AreEqual(id, (int)CXEData.TransactionStates.Committed);
			CXEMoneyTransferService.Verify(moq => moq.Commit(It.IsAny<long>()), Times.AtLeastOnce());
			CXEMoneyTransferService.Verify(moq => moq.Update(It.IsAny<long>(), It.IsAny<CXEData.TransactionStates>(), It.IsAny<string>()));
			CXNMoneyTransferService.Verify(moq => moq.Commit(It.IsAny<long>(), It.IsAny<MGIContext>()), Times.AtLeastOnce());
		}
		...
		[Test]
		public void Can_Get_Receive_Money_Transaction_By_Request()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
			TransactionRequest transactionRequest = new TransactionRequest() { CXNTransactionId = 1000000002, PTNRTransactionId = 1000000012 };
		...
		public void Can_Update_WUAccount()
		{
			...
			Assert.True(status);
			CXNMoneyTransferService.Verify(moq => moq.UseGoldcard(It.IsAny<long>(), It.IsAny<string>(), It.IsAny<MGIContext>()), Times.AtLeast(1));
		}

		[Test]
		public void Can_Update_Without_WUAccount()
		{
		...
		[Test]
		public void Can_Get_WUCardAccount_Without_CXE_Account()
		{
			long customerSessionId = 1000000015;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
		...
		public void Can_Search_Money_Transfer_For_Modify()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
			SearchRequest searchRequest = new SearchRequest() { SearchRequestType = SearchRequestType.Modify };
		...
		[Test]
		public void Can_Search_Money_Transfer_With_Lookup()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
			SearchRequest searchRequest = new SearchRequest() { TransactionId = 1000000001, SearchRequestType = SearchRequestType.Lookup };
		...
		[Test]
		public void Can_Search_Money_Transfer_For_Refund()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
		...
		[Test]
		public void Can_Get_Stage_Refund_With_FullAmount()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF" };
			RefundRequest refundRequest = new RefundRequest() { TransactionId = 1000000004, RefundStatus = "FullAmount" };

			long id = BIZMoneyTransferEngine.StageRefund(customerSessionId, refundRequest, mgiContext);

			Assert.AreNotEqual(id, 0);
			CXNMoneyTransferService.Verify(moq => moq.StageRefund(It.IsAny<CXNData.RefundRequest>(), It.IsAny<MGIContext>()), Times.AtLeast(1));
		}
		...
		[Test]
		public void Can_GetProviderAttributes_With_Transaction()
		{
			long customerSessionId = 1000000004;
			MGIContext mgiContext = new MGIContext() { ChannelPartnerName = "TCF", TrxId = 1000000001 };
			AttributeRequest attributeRequest = new AttributeRequest() { };

			List<Field> fields = BIZMoneyTransferEngine.GetProviderAttributes(customerSessionId, attributeRequest, mgiContext);

			Assert.AreNotEqual(fields.Count, 0);
			CXNMoneyTransferService.Verify(moq => moq.GetProviderAttributes(It.IsAny<CXNData.AttributeRequest>(), It.IsAny<MGIContext>()), Times.AtLeast(1));
		}
