...
namespace MGI.Unit.Test.MGI.Biz.Partner.Test
{
	...
	public class AgentSession_Fixture : BaseClass_Fixture
	{
		...
		public void Can_AuthenticateSSO()
		{
			...
			//ManageUserService.Verify(moq => moq.AddUser(It.IsAny<PTNRData.UserDetails>()), Times.Exactly(2));
		...
		public void Can_AuthenticateSSOWithExisting()
		{
			...
			Assert.IsNotNull(agent);
			//ManageUserService.Verify(moq => moq.UpdateUser(It.IsAny<PTNRData.UserDetails>()), Times.Exactly(2));
