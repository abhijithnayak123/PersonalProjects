...
namespace MGI.Unit.Test.MGI.Biz.Partner.Test
{
    ...
    public class ShoppingCartServiceImplTest : BaseClass_Fixture
    {
		...
		public void Can_Remove_Check_From_ShoppingCart()
		{
			...
			Assert.AreEqual(session.ActiveShoppingCart.ShoppingCartTransactions.Count(a => a.CartItemStatus == PNTRData.ShoppingCartItemStatus.Removed && a.Transaction.Type == 2), 3);
		}
		...
		public void Can_Remove_BillPay_From_ShoppingCart()
		{
			...
			Assert.AreEqual(session.ActiveShoppingCart.ShoppingCartTransactions.Count(a => a.CartItemStatus == PNTRData.ShoppingCartItemStatus.Removed && a.Transaction.Type == 4), 2);
		}
		...
		public void Can_Remove_Fund_From_ShoppingCart()
		{
			...
			Assert.AreEqual(session.ActiveShoppingCart.ShoppingCartTransactions.Count(a => a.CartItemStatus == PNTRData.ShoppingCartItemStatus.Removed && a.Transaction.Type == 3), 3);
		}
		...
		public void Can_Remove_MoneyOrder_From_ShoppingCart()
		{
			...
			Assert.AreEqual(session.ActiveShoppingCart.ShoppingCartTransactions.Count(a => a.CartItemStatus == PNTRData.ShoppingCartItemStatus.Removed && a.Transaction.Type == 5), 3);
		}
		...
		public void Can_Remove_MoneyTransfer_From_ShoppingCart()
		{
			...
			Assert.AreEqual(session.ActiveShoppingCart.ShoppingCartTransactions.Count(a => a.CartItemStatus == PNTRData.ShoppingCartItemStatus.Removed && a.Transaction.Type == 6), 3);
		}
