...
namespace TCF.Channel.Zeo.Web.Common
{
    public static class ShoppingCartHelper
    {
        ...
        public static void ParkShoppingCartTrx(long transactionId, ProductType productType, ZeoClient.ZeoContext context)
        {
            ZeoClient.ZeoServiceClient alloyServiceClient = new ZeoClient.ZeoServiceClient();
            ZeoClient.Response response = null;
            try
            {
                response = alloyServiceClient.ParkShoppingCartTransaction(transactionId, (int)productType, context);
