...
namespace TCF.Channel.Zeo.Web
{
    ...
    public class AtLeastOnePropertyAttribute : ValidationAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (null != propertyInfo.First(x => x.Name == "CardNumber").GetValue(value, null))
            {
                if (!(bool)propertyInfo.First(x => x.Name == "IsZeoCard").GetValue(value, null))
                {
                    if (null != propertyInfo.First(x => x.Name == "TCFCheckDateOfBirth").GetValue(value, null))
                        return true;
                    else
                        this.ErrorMessageResourceName = "IdentificationDateOfBirthRequired";
                    this.ErrorMessageResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo);
                    return false;
                }
                else
                    return true;
            }
            else if (null != propertyInfo.First(x => x.Name == "DateOfBirth").GetValue(value, null))
            {
                ...
                if (null != propertyInfo.First(x => x.Name == "AccountNumber").GetValue(value, null))
                    return true;
            }
    ...
    public class MinimumInitialLoadAmountAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            var IsCardActivationTrx = ((TCF.Channel.Zeo.Web.Models.ShoppingCartDetail)(((System.Web.Mvc.ViewContext)(context)).ViewData.Model)).IsCardActivationTrx;
            if (IsCardActivationTrx)
            {
                this.ErrorMessageResourceName = _errorMessageForInitialMinLoadAmount;
            }
