...
namespace TCF.Channel.Zeo.Web.Models
{
    public class SendMoneyTransactionModel : BaseModel
    {
        ...
        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyTranHistoryAmt")]
        public decimal Amount { get; set; }

        [Display(ResourceType = typeof(TCF.Channel.Zeo.Web.App_GlobalResources.Nexxo), Name = "SendMoneyTranHistoryType")]
