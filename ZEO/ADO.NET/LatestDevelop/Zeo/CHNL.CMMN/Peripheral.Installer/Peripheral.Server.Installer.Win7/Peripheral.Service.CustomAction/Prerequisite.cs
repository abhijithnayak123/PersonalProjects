		...
		public static string GetOSVersion()
		{
			...
			switch (_MajorVersion)
			{
				case 6:
					...
					{
						case 0:
                            Log.Writer(PeripheralConfig.INSTALL, "Operating System : Windows Vista");
							return "Windows Vista";
						case 1:
                            Log.Writer(PeripheralConfig.INSTALL, "Operating System : Windows 7");
							return "Windows 7";
						case 2:
                            Log.Writer(PeripheralConfig.INSTALL, "Operating System : Windows 8");
							return "Windows 8";
						default:
                            Log.Writer(PeripheralConfig.INSTALL, "Operating System : Windows Vista & above");
							return "Windows Vista & above";
					}
				default:
                    Log.Writer(PeripheralConfig.INSTALL, "Operating System : Unknown");
					return "Unknown";
			}
		}
