...
namespace TCF.Channel.Zeo.Service.Contract
{
    ...
    public interface ICustomerService
    {
        ...
        [OperationContract]
        Response SearchCoreCustomers(CustomerSearchCriteria searchCriteria, Data.ZeoContext context);
        ...
        [FaultContract(typeof(ZeoSoapFault))]
        [OperationContract]
        Response SearchCardCustomer(CustomerSearchCriteria criteria, Data.ZeoContext context);
