...
namespace MGI.Channel.Shared.Server.Data
{
	...
	public class Identification
	{
		...
		{
			string maskedId = string.IsNullOrWhiteSpace(GovernmentId) || GovernmentId.Length < 4 ? null : GovernmentId.Substring(GovernmentId.Length - 4, 4);
			...
			sb.AppendLine(string.Format("	ID: {0}{1}", "****", maskedId));
