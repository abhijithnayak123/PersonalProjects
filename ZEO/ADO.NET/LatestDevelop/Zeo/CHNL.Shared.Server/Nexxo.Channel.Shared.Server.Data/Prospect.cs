...
namespace MGI.Channel.Shared.Server.Data
{
	...
	public class Prospect
	{
		...
		public override string ToString()
		{
			...
			string maskedPatnerAccount = string.IsNullOrWhiteSpace(PartnerAccountNumber) || PartnerAccountNumber.Length < 6 ? null : PartnerAccountNumber.Substring(0, 6) + "XXXXXX" + PartnerAccountNumber.Substring(PartnerAccountNumber.Length - 4, 4);
			...
			if (!string.IsNullOrEmpty(CardNumber))
				sb.AppendLine(string.Format("   CardNumber: {0}",string.IsNullOrWhiteSpace(CardNumber) || CardNumber.Length < 4 ?null : string.Format("xx{0}", CardNumber.Substring(CardNumber.Length - 4))));
			else
			...
			if (!string.IsNullOrEmpty(PartnerAccountNumber))
				sb.AppendLine(string.Format("   PartnerAccountNumber : {0}",maskedPatnerAccount ));
