	...
	public partial class SharedEngine : IFundsProcessorService
	{
		...
		public FundsProcessorAccount LookupFundsAccount(long customerSessionId, MGIContext mgiContext)
		{
			...
			catch (System.Exception ex)
			{
				...
				MGI.Biz.FundsEngine.Data.BizFundsException bizFundsex = ex as MGI.Biz.FundsEngine.Data.BizFundsException;
				if (bizFundsex != null && bizFundsex.ProductCode == MGI.Biz.FundsEngine.Data.BizFundsException.FundsProductCode 
							&& (bizFundsex.AlloyErrorCode == "2019" || bizFundsex.AlloyErrorCode == MGI.Biz.FundsEngine.Data.BizFundsException.ACCOUNT_NOT_FOUND))
