    ...
    public class CashServiceImpl : ICashService
    {
        ...
        public long Create(Data.Transactions.Stage.Cash cash)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXECashException(CXECashException.CASH_CREATE_FAILED, ex);
            }
        }
		...
		public void Update(long Id, TransactionStates state, string timezone)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXECashException(CXECashException.CASH_UPDATE_FAILED, ex);
			}
		}
        ...
        public void Commit(long Id, string timezone)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXECashException(CXECashException.CASH_COMMIT_FAILED, ex);
            }
        }
