	...
	public class MoneyOrderServiceImpl : IMoneyOrderService
	{
		...
		public long Create(MoneyOrderStage moneyOrder, string timezone)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyOrderException(CXEMoneyOrderException.MONEYORDER_CREATE_FAILED, ex);
			}
		}
		...
		public void Update(long Id, int newStatus, string timezone)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyOrderException(CXEMoneyOrderException.MONEYORDER_UPDATE_FAILED, ex);
			}
		}
		...
		public void Commit(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyOrderException(CXEMoneyOrderException.MONEYORDER_COMMIT_FAILED, ex);
			}
		}
		...
		public MoneyOrderCommit Get(long Id)
		{
			...
			catch (Exception ex)
			{
				...
				throw new CXEMoneyOrderException(CXEMoneyOrderException.MONEYORDER_GET_FAILED, ex);
			}
		}
