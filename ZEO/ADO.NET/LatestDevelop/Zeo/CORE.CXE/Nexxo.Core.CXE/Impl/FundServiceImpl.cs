    ...
    public class FundServiceImpl : IFundsService
    {
        ...
        public long Create(Data.Transactions.Stage.Funds funds)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXEFundException(CXEFundException.FUND_CREATE_FAILED, ex);
            }
        }
        ...
        public void Update(long Id, TransactionStates state, string timezone)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXEFundException(CXEFundException.FUND_UPDATE_FAILED, ex);
            }
        }
        ...
        public void Commit(long Id, string timezone)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXEFundException(CXEFundException.FUND_COMMIT_FAILED,ex);
            }
        }
        ...
        public Data.Transactions.Commit.Funds Get(long Id)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new CXEFundException(CXEFundException.FUND_GET_FAILED, ex);
            }
        }
    }
}
