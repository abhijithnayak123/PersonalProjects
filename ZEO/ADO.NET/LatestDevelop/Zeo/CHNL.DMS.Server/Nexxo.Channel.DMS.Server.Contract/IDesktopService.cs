...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IDesktopService : ICustomerService, IAgentService, IDataStructuresService, IChannelPartnerService, ICheckCashingService,
        ...
        IUserService, ILocationService, INpsTerminalService, ITerminalService, ITransactionHistoryService, IReceiptsService, IMoneyOrderService, IMessageCenterService, ILocationCounterIdService, ILocationProcessorCredentialsService,IMessageStoreService
    {
	}
}
//, INLogLoggerService
