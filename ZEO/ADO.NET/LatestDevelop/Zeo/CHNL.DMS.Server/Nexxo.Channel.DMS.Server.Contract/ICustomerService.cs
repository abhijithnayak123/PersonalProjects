...
namespace MGI.Channel.DMS.Server.Contract
{
    ...
    public interface ICustomerService
    {
        ...
        [OperationContract]
		Response Lookup(long customerSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response GetProspect(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
		...
		Response Save(long agentSessionId, Prospect prospect, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
		Response Save(long agentSessionId, long alloyId, Prospect prospect, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response UpdateCustomer(long agentSessionId, long alloyId, Prospect prospect, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
		Response SearchCustomers(long agentSessionId, CustomerSearchCriteria searchCriteria, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
		Response InitiateCustomerSession(long agentSessionId, CustomerAuthentication authentication, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response RecordIdentificationConfirmation(long customerSessionId, string agentId, bool IdentificationStatus, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
		...
		Response Get(long agentSessionId, string Phone, string PIN, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
		Response ValidateSSN(long agentSessionId, string SSN, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response ValidateCustomer(long agentSessionId, Prospect prospect, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [OperationContract]
        [FaultContract(typeof(NexxoSOAPFault))]
        Response GetAnonymousUserPAN(long agentSessionId, long channelPartnerId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response CustomerLookUp(long agentSessionId, Dictionary<string, object> customerLookUpCriteria, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response ValidateCustomerStatus(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response NexxoActivate(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
        Response ClientActivate(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
        ...
        [FaultContract(typeof(NexxoSOAPFault))]
        [OperationContract]
		Response UpdateCustomerToClient(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		[OperationContract]
        Response CustomerSyncInFromClient(long agentSessionId, long alloyId, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		[OperationContract]
        Response CanChangeProfileStatus(long agentSessionId, long userId, string profileStatus, MGI.Channel.DMS.Server.Data.MGIContext mgiContext);
    }
}
