...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface IBillPayService
	{
		...
		Response GetBillers(long customerSessionId, long channelPartnerID, string searchTerm, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetBiller(long customerSessionId, long billerID, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetBillerByName(long customerSessionId, long channelPartnerID, string billerNameOrCode, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetFrequentBillers(long customerSessionId, long alloyId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetAllBillers(long customerSessionId, long channelPartnerID, Guid locationRegionID, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetLocations(long customerSessionId, string billerName, string accountNumber, decimal amount, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetFee(long customerSessionId, string billerNameOrCode, string accountNumber, decimal amount, BillerLocation location, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetBillerInfo(long customerSessionId, string billerNameOrCode, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetProviderAttributes(long customerSessionId, string billerNameOrCode, string location, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetFavoriteBiller(long customerSessionId, string billerNameOrCode, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetBillPayFee(long customerSessionId, string providerName, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response StageBillPayment(long customerSessionId, long transactionID, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response ValidateBillPayment(long customerSessionId, BillPayment billPayment, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetCardInfo(long customerSessionId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetAgent(long agentSessionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response AddPastBillers(long customerSessionId, string cardNumber, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response CancelBillPayment(long customerSessionId, long transactionId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
		Response DeleteFavoriteBiller(long customerSessionId, long billerID, MGIContext mgiContext);
