...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface ITerminalService
	{
        ...
        Response LookupTerminal(long Id, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
        Response LookupTerminal(long agentSessionId, string terminalName, int channelPartnerId, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response CreateTerminal(long agentSessionId, Terminal terminal, MGIContext mgiContext);
		...
		[OperationContract]
		[FaultContract(typeof(NexxoSOAPFault))]
        Response UpdateTerminal(long agentSessionId, Terminal terminal, MGIContext mgiContext);
	}
}
