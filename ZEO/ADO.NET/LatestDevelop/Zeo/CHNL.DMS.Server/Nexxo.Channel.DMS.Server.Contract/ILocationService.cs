...
namespace MGI.Channel.DMS.Server.Contract
{
	...
	public interface ILocationService
	{
		...
		Response GetByName(long agentSessionId, string locationName, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response Create(long agentSessionId, Location manageLocation, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response Update(long agentSessionId, Location manageLocation, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response Lookup(string agentSessionId, long locationId, MGIContext mgiContext);
		...
		[FaultContract(typeof(NexxoSOAPFault))]
		Response GetAll(long agentSessionId, MGIContext mgiContext);
	}
}
