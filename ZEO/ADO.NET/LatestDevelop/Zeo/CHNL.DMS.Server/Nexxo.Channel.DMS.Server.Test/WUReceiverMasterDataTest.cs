...
namespace MGI.Channel.DMS.Server.Test
{
	...
	public class WUReceiverMasterDataTest : AbstractTransactionalSpringContextTests
	{
		...
		public void MobileProvidersTest()
		{
            ...
            Response response = DeskTopTest.MobileProviders(0, mgiContext);
			mobileProviders = response.Result as List<string>;
		...
		public void PhoneTypesTest()
		{
            ...
            Response response = DeskTopTest.PhoneTypes(0, mgiContext);
			phoneTypes = response.Result as List<string>;
